...
if __name__ == '__main__':
    random.seed(42)
    extract_samples('data/train.json', 'data/train_samples.json', 2000)
    extract_samples('data/dev.json', 'data/dev_samples.json', 500)
    extract_samples('data/test.json', 'data/test_samples.json', 500)